...
const Reviews: React.FC = () => {
  return (
    <div className="pt-24 pb-16 px-4 md:px-8 max-w-7xl mx-auto">
      ...
      >
        <h1 className="text-4xl md:text-6xl font-bold mb-4">Client Success Stories</h1>
        <p className="text-lg text-gray-600">Real experiences from real clients.</p>
      </motion.div>
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="bg-white p-6 rounded-lg shadow-lg">
            ...
            <p className="text-gray-700">I'll step in, sort things out, or suggest better options.</p>
          </div>
          <div className="bg-white p-6 rounded-lg shadow-lg">
          ...
          <div className="bg-white p-6 rounded-lg shadow-lg">
            ...
            <p className="text-gray-700">Yes. I only suggest people I've personally reviewed.</p>
          </div>
          <div className="bg-white p-6 rounded-lg shadow-lg">
            <h3 className="text-xl font-semibold mb-3">Will I get updates during the project?</h3>
            <p className="text-gray-700">Yes, I stay in touch and keep you posted.</p>
          </div>
          <div className="bg-white p-6 rounded-lg shadow-lg">
            <h3 className="text-xl font-semibold mb-3">Can you handle custom project needs?</h3>
            <p className="text-gray-700">Definitely. Just share the idea — I'll build the right team.</p>
          </div>
        </div>
      </motion.div>
      ...
      >
        <div className="flex flex-col items-center text-center p-6 bg-white rounded-lg shadow-lg">
          <Shield size={40} className="mb-4 text-black" />
          <h3 className="text-xl font-semibold mb-2">Delivery Assurance</h3>
          <p className="text-gray-700">If the freelancer fails to deliver, I step in personally to fix it.</p>
        </div>
        <div className="flex flex-col items-center text-center p-6 bg-white rounded-lg shadow-lg">
          <Clock size={40} className="mb-4 text-black" />
          <h3 className="text-xl font-semibold mb-2">24/7 Support</h3>
          <p className="text-gray-700">Get assistance whenever you need it.</p>
        </div>
        <div className="flex flex-col items-center text-center p-6 bg-white rounded-lg shadow-lg">
          <Award size={40} className="mb-4 text-black" />
...
const reviews = [
  {
    ...
    content: "Working with Rishidar was a game-changer. He connected us with exactly the talent we needed.",
    date: "March 2024"
  },
  {
    name: "Michael Chen",
